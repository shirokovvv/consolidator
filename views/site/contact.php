...
<div class="contactdiv">
    ...
    <?php if (Yii::$app->session->hasFlash('contactFormSubmitted')): ?>
        ...
        <div class="alert alert-success">
            Спасибо за то, что связались с нами. Мы Вам ответим как можно скорее.
        </div>
    ...
    <?php else: ?>
        <p>&nbsp</p>
        <p>
            Если у Вас есть вопросы или предложения, пожалуйста, заполните эту форму для связи с нами.
            Спасибо.
        </p>
        <p>&nbsp</p>
        <div class="">
            <div class="col-lg-5">
                ...
                <?php $form = ActiveForm::begin(['id' => 'contact-form']); ?>
                    ...
                    <div class="form-group">
                        <?= Html::submitButton('Submit', ['class' => 'btn btn-primary', 'name' => 'contact-button', 'label'=>'Отправить',]) ?>
                    </div>
